const routes = [
  {
    ...
    children: [
      { path: "", name: "home", component: () => import("src/pages/home/Index.vue") },
      { path: "/login", name: "login", component: () => import("pages/Security/Login.vue") },
      { path: "/signup", name: "signup", component: () => import("pages/Security/SignUp.vue") },
    ],
  },
  {
    path: "/services",
  ...
  },
  {
    ...
    component: () => import("layouts/MainLayout.vue"),
    children: [
      { path: "/store", name: "store", component: () => import("pages/store/Index.vue") }
    ],
  },
  {
    path: "/blog",
